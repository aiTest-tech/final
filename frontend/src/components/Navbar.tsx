    ...
    <div className="flex justify-between items-center p-4 border-b">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="text-xl flex gap-2 items-center">
          A
          <span className="bg-black rounded-full text-white flex items-center justify-center w-4 h-4 text-lg">
            +
          </span>
        </button>
        <button className="text-xl flex gap-2 items-center">
        ...
        <button><FaYoutube size={20} /></button>
        <button><FaSquareXTwitter size={20} /></button>
        <button><AiFillInstagram size={20} /></button>
      </div>
    </div>
  );
};
